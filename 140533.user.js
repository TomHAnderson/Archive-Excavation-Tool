...
//    alert($.jquery); // check jQuery version
    ...
    if ($('a.titleLink').length) {
        ...
        $('<ul id="IAFT-top-nav"><li><a href="/web/web.php">Web</a></li><li><a href="/details/movies">Movies</a></li><li><a href="/details/texts">Text</a></li><li><a href="/details/audio">Sound</a></li><li><a href="/details/software">Software</a></li><li><a href="/about/">About</a></li><li><a href="/create/">Upload</a></li></ul><ul id="IAFT-secondary-nav" class="audio"></ul>').insertBefore('.breadcrumbs');
